...
Lightweight recovery using copilot-instructions.md (auto-loaded at startup).
...
**Note**: After `/clear`, your role instructions (`instructions/generated/copilot-ashigaru.md`) are lost. However, `shutsujin_departure.sh` loaded them at deployment, and copilot-instructions.md contains enough context to operate. If critical role info is needed, re-read `instructions/generated/copilot-ashigaru.md` manually (rare case — most tasks don't need it).
